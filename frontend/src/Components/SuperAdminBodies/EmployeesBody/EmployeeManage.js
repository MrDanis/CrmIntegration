  ...
  return (
     ...
     <div className='col-12 bg-dark py-2 d-flex clearfix subpageTitleHeading'>
      <div className='row w-100 m-0 p-0'> 
       <div className='col-12 m-0 p-2 bg-dark text-light d-flex flex-row'>
        ...
        <Link to={'/Employees/Manage/Invites'} className='text-decoration-none text-light fw-bold m-0 py-0 px-2 rounded-pill ManageComapny d-flex align-items-center justify-content-center'>
          Manage Invites
        </Link>
        </div>
        </div>
    ...
    <div className='col-12 bg-dark px-1 py-2 m-0 p-0 d-flex justify-content-end align-items-center'>
         {/* Common Component two start from here */}
          <button className='btn btn-primary rounded-pill text-light d-flex align-items-center justify-content-center'>
